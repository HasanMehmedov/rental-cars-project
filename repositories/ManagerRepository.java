...
public class ManagerRepository extends DataRepository<Manager> {
    ...
    @Override
    protected Manager parseRow(ResultSet rs) throws SQLException {
        int id = rs.getInt("id");
        ...
        return new Manager(id, username, password, firstName, lastName, egn, phoneNumber, email, salary, branchId);
    }
    ...
    protected String getColumns() {
        return "username, password, first_name, last_name, egn, " +
                "phone_number, email, salary, branch_id";
    }
    ...
    @Override
    protected List<String> getValues(Manager element) {
        return List.of(element.getUsername(), element.getPassword(), element.getFirstName(), element.getLastName(),
                ...
                String.valueOf(element.getBranchId()));
    }
}
