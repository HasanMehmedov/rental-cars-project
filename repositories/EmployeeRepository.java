...
public class EmployeeRepository extends DataRepository<Employee> {
    ...
    protected List<String> getValidationColumns() {
        return List.of("username", "password", "manager_id");
    }
    ...
    @Override
    protected Employee parseRow(ResultSet rs) throws SQLException {
        int id = rs.getInt("id");
        ...
        return new Employee(id, username, password, firstName, lastName, egn, phoneNumber, email, salary, managerId, branchId);
    }
    ...
    protected String getColumns() {
        return "username, password, first_name, last_name, egn, " +
                "phone_number, email, salary, manager_id, branch_id";
    }
    ...
    @Override
    protected List<String> getValues(Employee element) {
        return List.of(element.getUsername(), element.getPassword(), element.getFirstName(), element.getLastName(),
                element.getEgn(), element.getPhoneNumber(), element.getEmail(), String.valueOf(element.getSalary()),
                String.valueOf(element.getManagerId()), String.valueOf(element.getBranchId()));
    }
}
